        ...
        <div className='ml-14 flex items-center gap-16'  >
          ...
          <Link to='/cart' className='flex gap-3'>
            <div className="relative w-fit">
              <FontAwesomeIcon className="w-7 h-7 text-white" icon={faCartShopping} />
              {cart.length > 0 && Object.keys(account).length > 0 && <div className="absolute top-0 right-0 w-3 h-3 bg-red-500 rounded-full text-white flex justify-center items-center font-bold text-[9px]">{cart.length}</div>}
            </div>
